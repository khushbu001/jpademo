 ...
 * @Configuration
 * 
 * @EnableSwagger2 public class SwaggerConfigure {
 * 
 *//**
	 * @Description This method will use for API Documentation
	 *//*
		 * @Bean public Docket userApi() { return new
		 * Docket(DocumentationType.SWAGGER_2).select()
		 * .apis(RequestHandlerSelectors.basePackage("com.employee.employeemanagement"))
		 * .build(); } }
		 */